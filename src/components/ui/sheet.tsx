...
const sheetVariants = cva(
  ...
  ),
  {
    variants: {
      side: {
        top: cn(
          "inset-x-0 top-0 border-b border-border/30 rounded-b-2xl p-6",
          "data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top"
        ),
        bottom: cn(
          "inset-x-0 bottom-0 border-t border-border/30 rounded-t-2xl p-6 safe-area-bottom",
          "data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom"
        ),
        left: cn(
          "inset-y-0 left-0 h-full w-3/4 border-r border-border/30 p-6 sm:max-w-sm",
          "data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left"
        ),
        right: cn(
          "inset-y-0 right-0 h-full w-3/4 border-l border-border/30 p-6 sm:max-w-sm",
    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content ref={ref} className={cn(sheetVariants({ side }), className)} {...props}>
        ...
        <SheetPrimitive.Close className={cn(
          ...
          "opacity-70 ring-offset-background transition-all duration-fast",
